...
- weighted scoring v2.0.0 (affected-page-ratio model, `ScoringEngine.Version` is the source of truth), Persian-aware duplicate clustering and internal-link graph analysis
