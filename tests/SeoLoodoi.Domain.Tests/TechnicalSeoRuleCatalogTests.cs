...
public class TechnicalSeoRuleCatalogTests
{
    ...
    public void HtmlSnapshotGate_ComesFromMetadata_NotAHardCodedList()
    {
        ...
        [
            ...
            "CONTENT_TYPE_UNSUPPORTED", "REDIRECT_LOOP", "URL_TOO_LONG", "URL_TOO_DEEP", "URL_UPPERCASE",
            "URL_ENCODING_ANOMALY", "URL_FRAGMENT", "URL_TRACKING_PARAMETER", "URL_PARAMETER_DUPLICATE"
        ];
        foreach (var rule in RegisteredRules())
        {
