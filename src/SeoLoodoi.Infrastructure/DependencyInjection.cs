...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration config)
    {
        ...
        services.AddSingleton<ISeoRule, MetaRobotsNoFollowRule>();
        services.AddSingleton<ISeoRule, MetaRobotsNoArchiveRule>();
        services.AddSingleton<ISeoRule, MetaRobotsNoSnippetRule>();
        services.AddSingleton<ISeoRule, MetaRobotsNoImageIndexRule>();
        services.AddSingleton<ISeoRule, XRobotsNoFollowRule>();
        services.AddSingleton<ISeoRule, IndexabilityContradictionRule>();
        services.AddSingleton<ISeoRule, CanonicalExternalRule>();
        services.AddSingleton<ISeoRule, Soft404Rule>();
        services.AddSingleton<ISeoRule, RedirectLoopRule>();
        services.AddSingleton<ISeoRule, ContentTypeUnsupportedRule>();
        services.AddSingleton<ISeoRule, UrlTooLongRule>();
        services.AddSingleton<ISeoRule, UrlTooDeepRule>();
        services.AddSingleton<ISeoRule, UrlUpperCaseRule>();
        services.AddSingleton<ISeoRule, UrlEncodingAnomalyRule>();
        services.AddSingleton<ISeoRule, UrlFragmentRule>();
        services.AddSingleton<ISeoRule, UrlTrackingParameterRule>();
        services.AddSingleton<ISeoRule, UrlParameterDuplicateRule>();
