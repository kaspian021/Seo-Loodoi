...
public enum SeoJobType { InitialCrawl, ContinueCrawl, AnalyzeCrawl, CalculateScores, GenerateRecommendations, GenerateReport, MonitoringCheck, Cleanup, CompetitorCrawl, BacklinkRefresh }
