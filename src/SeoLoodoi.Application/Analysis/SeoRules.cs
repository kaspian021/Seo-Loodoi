...
public sealed record PageAnalysisContext(string Url, string? Title, string? MetaDescription, IReadOnlyList<string> H1s, string? Canonical, int WordCount, int ImageCount, int MissingAltCount, long ResponseTimeMs, bool IsIndexable = true, IReadOnlyList<int>? HeadingLevels = null, int StatusCode = 200, string? ContentType = null, string? XRobotsTag = null, string? RobotsMeta = null, string? RedirectChainJson = null, string? AssetsJson = null, string? SchemaJson = null, string? HreflangJson = null, string? HeadersJson = null, int Depth = 0, string? TextContent = null);
