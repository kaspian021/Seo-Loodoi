...
public sealed record ScoreDto(decimal? Overall, decimal? Technical, decimal? Indexability, decimal? OnPage, decimal? Content, decimal? Links, decimal? StructuredData, decimal? Performance, decimal? International, decimal? Security, string Version, DateTimeOffset CreatedAt, Guid? CrawlId, bool IsPartial);
